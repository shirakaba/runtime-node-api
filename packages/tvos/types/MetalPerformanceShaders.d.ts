...
declare class unnamed_16200937871979405073 {
  constructor(init?: unnamed_16200937871979405073);
  x: number;
  y: number;
  z: number;
}
...
type unnamed_6958223695034831895Descriptor = 
  | { elements: unknown /* const array */ };

declare class unnamed_6958223695034831895 {
  constructor(init?: unnamed_6958223695034831895Descriptor);
  elements: unknown /* const array */;
}
